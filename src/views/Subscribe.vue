  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center">
            ...
            <span class="ml-2 text-xl font-semibold text-gray-900">Premium App</span>
          </div>
    ...
    <main class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <div class="text-center animate-fade-in">
        <!-- Canceled Message -->
        <div v-if="canceled" class="mb-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <div class="flex items-center justify-center">
            ...
            <p class="text-yellow-800">Payment was canceled. You can try again anytime.</p>
          </div>
        </div>
        ...
        <div class="mb-12">
          ...
          <p class="text-xl text-gray-600 max-w-2xl mx-auto">
            Subscribe to access your dashboard and all premium features. Cancel anytime.
          </p>
        </div>
        ...
        <div class="max-w-md mx-auto">
          <div class="card p-8 animate-slide-up">
            <div class="text-center mb-6">
              ...
              <h3 class="text-xl font-semibold text-gray-900 mb-2">Premium Access</h3>
        ...
        <div class="mt-12 max-w-2xl mx-auto">
          <div class="bg-gray-50 rounded-lg p-6">
            <div class="flex items-center justify-center mb-4">
              ...
              <h4 class="text-lg font-medium text-gray-900">Secure & Trusted</h4>
            </div>
            <p class="text-gray-600 text-center">
              Your payment information is encrypted and secure. We use Stripe for payment processing and never store your credit card details.
            </p>
          </div>
        </div>
      </div>
